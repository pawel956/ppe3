...
public class GoogleOAuth2 {
    ...
    private String[] informationsUtilisateur = new String[3];
    ...
    public GoogleOAuth2() {
        try {
            ...
            Userinfoplus utilisateur = oauth2.userinfo().get().execute();

            this.informationsUtilisateur[0] = utilisateur.getFamilyName();
            this.informationsUtilisateur[1] = utilisateur.getGivenName();
            this.informationsUtilisateur[2] = utilisateur.getEmail();
            // success!
            return;
        } catch (IOException e) {
     ...
     */
    private static final String APPLICATION_NAME = "ppe3/1.0";
...
//                new InputStreamReader(GoogleOAuth2.class.getResourceAsStream("/identifiants_google.json")));
//        if (clientSecrets.getDetails().getClientId().startsWith("Enter")
//                || clientSecrets.getDetails().getClientSecret().startsWith("Enter ")) {
//            System.out.println("Enter Client ID and Secret from https://code.google.com/apis/console/ "
//                    + "into oauth2-cmdline-sample/src/main/resources/identifiants_google.json");
//            System.exit(1);
//        }
        // set up authorization code flow
        GoogleAuthorizationCodeFlow flow = new GoogleAuthorizationCodeFlow.Builder(
                httpTransport, JSON_FACTORY, Constants.CLIENT_ID, Constants.CLIENT_SECRET, SCOPES).build();
//        GoogleAuthorizationCodeFlow flow = new GoogleAuthorizationCodeFlow.Builder(
